...
| `1.0.12`| Explicit `coordinationScopesBy` property for view definitions. |
| `1.0.13`| Adds the `coordinationValues` property for file definitions. |
| `1.0.14`| Adds the `coordinationValues` property for view definitions. |
